    ...
    <body>
        ...
        <div class="container" id="content">
            ...
            <div class="jumbotron home-spacer" id="products-jumbotron">
                ...
                <p>We have the best Mens, Womens and Child clothes for you. No need to hunt around, we have all in one place.</p>
                        ...
                        <div class="caption">
                            ...
                            <?php if (!isset($_SESSION['email'])) { ?>
                                ...
                                if (check_if_added_to_cart(2)) { //This is same as if(check_if_added_to_cart != 0)
                                    echo '<a class="btn btn-block btn-success" disabled>Added to cart</a>';
                                } else {
                                    ?>
